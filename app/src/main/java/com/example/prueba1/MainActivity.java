...
public class MainActivity extends AppCompatActivity {
    ...
    public void activity15(View view){
        Intent act15 = new Intent(this, activity_15.class);
        startActivity(act15);
    }
    ...
    public void activity48(View view){
        Intent act48 = new Intent(this, activity_48.class);
        startActivity(act48);
    }

    public void activity50(View view){
